...
| Document | Purpose | When to Use |
|----------|---------|-------------|
| **Part01-Discord-Integration.md** | Legacy Discord steps | Reference only (use Complete Guide instead) |
| **Part02-Workflow-Examples.md** | Example automation workflows | After basic setup, for inspiration |
| **Part03-Easy-Startup.md** | Auto-start scripts | Setting up daily usage shortcuts |
| **Part04-Advanced-Config.md** | Advanced configurations | Customization and optimization |
| **Part05-Troubleshooting.md** | Common problems and fixes | When something doesn't work |
| **Part07-Appendix.md** | Reference information | Looking up specific details |
| **CONTAINERIZATION-FAQ.md** | Docker questions answered | Deciding between WSL and Docker |
| **DOCKER-SETUP.md** | Detailed Docker setup | In-depth Docker configuration |
...
**...create my own workflows**
→ [Part02-Workflow-Examples.md](Part02-Workflow-Examples.md)

**...make the system start automatically**
→ [Part03-Easy-Startup.md](Part03-Easy-Startup.md)
→ [DOCKER-LAUNCH-QUICKSTART.md](DOCKER-LAUNCH-QUICKSTART.md) - Auto-Start section

**...fix a problem**
→ [Part05-Troubleshooting.md](Part05-Troubleshooting.md)
→ [00-COMPLETE-SETUP-GUIDE.md](00-COMPLETE-SETUP-GUIDE.md) - Troubleshooting section

**...share this with a friend**
→ [Part07-Appendix.md](Part07-Appendix.md) - Sharing Guide
→ [DOCKER-LAUNCH-QUICKSTART.md](DOCKER-LAUNCH-QUICKSTART.md) - Option B
...
3. Review Part02-Workflow-Examples.md for ideas

### Intermediate
1. Create custom workflows in n8n
2. Set up auto-start scripts (Part03)
3. Migrate to Docker for easier management
...
├── DOCKER-SETUP.md
├── Part01-Discord-Integration.md
├── Part02-Workflow-Examples.md
├── Part03-Easy-Startup.md
├── Part04-Advanced-Config.md
├── Part05-Troubleshooting.md
└── Part07-Appendix.md
