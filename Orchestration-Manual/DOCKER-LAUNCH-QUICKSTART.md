...
### Step B4: Create Discord Webhook

**In your Discord server:**

1. Right-click channel → Edit Channel
2. Integrations → Webhooks → New Webhook
3. Name: "Claude Response"
4. **Copy webhook URL**
5. Save Changes

### Step B5: Get Anthropic Credentials
...
ANTHROPIC_API_KEY=your_api_key_from_step_B5
```

**Save and close.**

### Step B7: Launch Docker
